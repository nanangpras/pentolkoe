    ...
    @if (Auth::user()->role == 'admin')
        <div class="page-sidebar-inner slimscroll">
            <ul class="accordion-menu">
                ...
                <li class="{{ set_active(['course.education.index','course.education.create','course.education.edit']) }}">
                    <a href="{{route('course.education.index')}}" ><i class="material-icons">school</i>Edukasi</a>
                </li>
