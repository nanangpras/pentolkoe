...
<div class="main-wrapper">
    ...
    <div class="row">
        <div class="col-xl">
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">Input Chapter</h5>
                    <form action="{{route('course.input.chapter')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group">
                            <label for="exampleInputEmail1">Pilih Produk</label>
                            <select name="product_id" id="product_id" class="form-control" data-type="edukasi">
                        ...
                        <div class="form-group">
                            <label for="exampleInputEmail1">Nama Chapter</label>
