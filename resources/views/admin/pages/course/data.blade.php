    ...
    <div class="row">
        <div class="col-md-12">
            <div class="page-title">
                <a href="{{route('course.chapter')}}" class="btn btn-primary btn-sm"  style="float: right;">Input Produk</a>
                        ...
                        <tbody>
                            @foreach ($data as $item)
                                <tr>
                                    ...
                                    <td>{{$item->link}}</td>
                                    <td>
                                        <a href="{{route('course.education.show',$item->id)}}" class="btn btn-sm btn-secondary">Detail</a>
